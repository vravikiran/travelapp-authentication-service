...
public class TravelAgentProfile {
	...
	public String toString() {
		return "TravelAgentProfile [mobileno_hash=" + mobileno_hash + ", email_hash=" + email_hash + ", isactive="
				+ isactive + ", role=" + role + ", created_date=" + created_date + ", updated_date=" + updated_date
				+ "]";
	}
